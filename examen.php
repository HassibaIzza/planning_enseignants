...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Emplois Examen </h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Accueil</a></li>
              <li class="breadcrumb-item active">Emplois Examen</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Emplois Examen</h3>

                <div class="card-tools">
					<form method="GET" class="form-inline">
						<input type="hidden" name="examen" value="0" />
                ...
                <table class="table table-bordered table-striped ">
                  ...
                  <tbody>
					<?php
						...
						$enseignant_id = "(select enseignant_nom from ge_enseignants where ge_enseignants.enseignant_id = surveillance_examen.enseignant_id) as enseignant_nom";
						$module_id = "(select module_nom from ge_modules where ge_modules.module_id = surveillance_examen.module_id) as module_nom";
						$salle_id = "(select salle_nom from ge_salles where ge_salles.salle_id = surveillance_examen.salle_id) as salle_nom";
						
						$specialite_nom = "(SELECT specialite_nom from ge_specialites where ge_specialites.specialite_id in (select ge_modules.specialite_id from ge_modules where ge_modules.module_id = surveillance_examen.module_id)) as specialite_nom";
						
						$query=mysqli_query($con, "SELECT *, ".$enseignant_id.", ".$module_id.", ".$salle_id." , ".$specialite_nom." FROM surveillance_examen where ".$specialite_id_cond." and ".$emploi_semestre_condition." and ".$annee_nom_condition);
						...
						if( $query->num_rows > 0 )
						{
							while($client_array=mysqli_fetch_array($query))
							{
								...
								?>
									<tr>
										<td><?= $client_array["jour"]; ?></td>
										<td><?= $client_array["temp"]; ?></td>
										...
										<td>
											<?php
												...
												{
													?>
														<a href="index_user.php?examen_add=<?=$client_array["id"];?>" class=""><i class="fa fa-edit"></i></a>

														<a onclick="if(!confirm('Confirmer cette etape')) return false;" href="ajax.php?function=delete_examen&id=<?= $client_array["id"]; ?>"><i  style='' class="fa fa-trash"></i></a>
													<?php
												}
											?>
										</td>
