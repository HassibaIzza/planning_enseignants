					...
					<div class="row">
						<div class="col-lg-3 col-6">
							<div class="small-box bg-info">
								<div class="inner">
									<h3><?php echo mysqli_num_rows(mysqli_query($con, "SELECT * FROM ge_specialites")); ?></h3>
									<p>Spécialités</p>
								</div>
								<div class="icon">
						...
						<div class="col-lg-3 col-6">
							<div class="small-box bg-info">
								...
								<a href="index.php?enseignants=0" class="small-box-footer">Voir tout <i class="fas fa-arrow-circle-right"></i></a>
							</div>
						</div>
						<div class="col-lg-3 col-6">
							<div class="small-box bg-info">
						...
						<div class="col-lg-3 col-6">
							<div class="small-box bg-info">
								...
								<a href="index.php?cycles=0" class="small-box-footer">Voir tout <i class="fas fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<?php
