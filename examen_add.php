...
<?php
	...
	$function_to_call = "examen_add";
	
	
	if( $_GET["examen_add"] != 0 )
	{
		$element_array_rows = mysqli_query($con, "select * from surveillance_examen where id = '".$_GET['examen_add']."'");
		$element_array = mysqli_fetch_array($element_array_rows);
		$title_produit = "Modifier";
		$function_to_call = "examen_edit&id=".$_GET['examen_add'];
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											<label>Jour</label>
											<select class="form-control" name="emploi_jour" id="emploi_jour" required>
									...
									<div class="col-sm-6">
										<div class="form-group">
											<label>Temp</label>
											<select class="form-control" name="emploi_temp" id="emploi_temp" required>
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											...
											<select class="form-control" name="enseignant_nom" id="enseignant_id" required>
												<?php
									...
									<div class="form-group">
											...
											<select type="date" class="form-control" id="emploi_semestre" name="emploi_semestre" required>
