                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <li class="nav-item">
                                <a href="index_user.php?emplois_add=0" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <li class="nav-item">
                                <a href="index_user.php?examen_add=0" class="nav-link">
                                <i class="fa fa-plus-square nav-icon"></i>
                                <p>Saisir</p>
                                </a>
                            </li>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="index_user.php?réservation=0" class="nav-link">
                                <i class="fas fa-table nav-icon"></i>
                                <p>Réservation</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="index_user.php?réservéSalle=0" class="nav-link">
                                <i class="fa fa-plus-square nav-icon"></i>
                                <p>Ajouter</p>
                                </a>
                            </li>
