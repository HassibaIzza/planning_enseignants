					...
					<?php
						...
						if( isset($_GET["enseignant_nom"]) )
						{
							if( !empty($_GET["enseignant_nom"]) )
							{
								...
								$query = mysqli_query($con, "SELECT ge_enseignants.enseignant_nom, ge_emplois.emploi_temp as enseignant_heur, ge_emplois.emploi_jour as enseignant_jour, ge_salles.salle_nom
								FROM ge_enseignants
								LEFT JOIN ge_emplois ON ge_enseignants.enseignant_id = ge_emplois.enseignant_id
								LEFT JOIN ge_salles ON ge_emplois.salle_id = ge_salles.salle_id
								WHERE ge_enseignants.enseignant_nom = '$enseignant_nom' and ge_emplois.emploi_annee_univ ='$annee_nom_condition' and  ge_emplois.emploi_semestre = '$emploi_semestre_condition'
								GROUP BY ge_emplois.emploi_jour");
